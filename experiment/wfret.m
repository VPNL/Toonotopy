function params = wfret(params,padUpperPx,padLowerPx)
% [params] = ret([params])
%
...
if ~exist('padUpperPx', 'var'), padUpperPx = 120; end
params.padUpperPx = padUpperPx;

if ~exist('padLowerPx', 'var'), padLowerPx = 230; end
params.padLowerPx = padLowerPx;
...
params.tr=2;
params = setRetinotopyParamsWF(params.experiment, params);

% set response device
params = setRetinotopyDevices(params);

params.saveMatrix = 'images'; 

% go
doRetinotopyScanWF(params);
