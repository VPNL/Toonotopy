...
% Last Modified by GUIDE v2.5 17-Aug-2018 13:19:20
...
set(handles.fixSize,            'String',   num2str(data.fixSize));
...
data.fixSize         = str2num(get(handles.fixSize,     'String')); %#ok<*ST2NM>
...
handles.data.fixSize = str2num(get(hObject,'String'));
guidata(hObject,handles);
return;
