function params = retSetCommonDefaultsWF(params, expName)
%
...
% ************************
    if ~isempty(params.calibration),
        ...
        params.display = loadDisplayParams('numpixels',[1280 960-params.padUpperPx-params.padLowerPx]);
...
params.display.fixSizePixels = 3; %params.fixSize;%3;%6;12 (radius of fixation)
